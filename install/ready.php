...
<ol>
 ...
 <li>Sowohl in der .htacces im Hauptordner als auch im Unterordner admin/ muss in der zweiten Zeile (RewriteBase) und in der letzten Zeile (ErrorDocument 404) der Pfad angepasst werden.</li>
 <li>In der Datei admin/js/editor.js in der Zeile 141 muss der Pfad zum Adminbereich angepasst werden</li>
 <li>Setze den chmod der Konfigurationsdatei config.php in config/ auf 444</li>
 <li>Lösche den Ordner install/ (oder bennene ihn wenigstens um)</li>
 <li>Ändere die impressum.php und aboutme.php des verwendeten Designs</li>
</ol>
<br />
<p>Schritte 1-3 kannst du aber auch automatisiert erledigen lassen.</p>
